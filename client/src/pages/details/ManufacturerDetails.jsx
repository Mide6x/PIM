...
const ManufacturerDetails = () => {
    ...
    const fetchManufacturerDetails = async () => {
      ...
      try {
        const response = await axios.get(
          `https://prod-nnal.onrender.com/api/v1/manufacturer/${id}`
        );
  ...
  const handleSave = async () => {
    try {
      ...
      if (isEditingManufacturer) {
        await axios.put(`https://prod-nnal.onrender.com/api/v1/manufacturer/${id}`, {
          ...manufacturer,
  ...
  const handleArchive = async () => {
    try {
      await axios.patch(`https://prod-nnal.onrender.com/api/v1/manufacturer/${id}/archive`);
      setIsArchived(true);
  ...
  const handleUnarchive = async () => {
    try {
      await axios.patch(
        `https://prod-nnal.onrender.com/api/v1/manufacturer/${id}/unarchive`
      );
      setIsArchived(false);
